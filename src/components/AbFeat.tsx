  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20 space-y-32">
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="flex-1 max-w-md md:max-w-lg rounded-lg overflow-hidden shadow-xl">
          <img
            ...
            width={600}
            height={400}
            className="object-cover rounded-lg border-4 border-blue-600 shadow-3xl shadow-gray-900 dark:shadow-white"
          />
      ...
      <div className="text-center max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 border-1">
          {[
            ...
            <Card key={title} className="p-6 rounded-xl shadow-md hover:shadow-lg transition">
      ...
      <div className="relative bg-blue-600 dark:bg-blue-500 py-16 mt-20 rounded-xl text-center overflow-hidden">
        ...
        <Button
          size="lg"
          className="relative bg-white text-blue-600 font-bold hover:bg-gray-100 transition"
        >
          Get Started Now
        </Button>
      </div>
